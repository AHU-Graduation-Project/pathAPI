...
import { topic, topicKeywords, roadmap, roadmapResource, edge, topicResource, follow, user, achievedRoadmap, roadmapKeywords, achievedTopic, roadmapFeedback } from "./schema";
...
export const roadmapResourceRelations = relations(roadmapResource, ({one}) => ({
	roadmap: one(roadmap, {
...
export const achievedRoadmapRelations = relations(achievedRoadmap, ({one}) => ({
	roadmap: one(roadmap, {
...
export const roadmapKeywordsRelations = relations(roadmapKeywords, ({one}) => ({
	roadmap: one(roadmap, {
...
export const roadmapFeedbackRelations = relations(roadmapFeedback, ({one}) => ({
	roadmap: one(roadmap, {
